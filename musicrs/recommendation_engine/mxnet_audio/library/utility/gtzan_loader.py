...
from musicrs.recommendation_engine.mxnet_audio.library.utility.download_utils import reporthook
...
def download_gtzan_music_speech(data_dir_path):
    ...
    if not os.path.exists(zip_file_path):
        ...
        urllib.request.urlretrieve(
            url=url_link, filename=zip_file_path, reporthook=reporthook
        )
